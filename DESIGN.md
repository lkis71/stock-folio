...
### Phase 1: MVP
- [ ] Xcode 프로젝트 생성 (SwiftUI, iOS 16.0+)
- [ ] Core Data 모델 설정 (StockHolding Entity)
- [ ] UserDefaults로 시드머니 저장/로드
- [ ] 시드머니 설정 화면
- [ ] 메인 화면 UI 구성 (시드머니 정보 포함)
- [ ] 종목 추가 화면 구성
- [ ] Core Data CRUD 기능 구현
- [ ] 기본 리스트 표시

### Phase 2: 차트 구현
- [ ] Swift Charts로 파이 차트 구현
- [ ] 종목별 색상 자동 할당
- [ ] 비중 레이블 표시
- [ ] 차트 인터랙션 (탭, 하이라이트)
